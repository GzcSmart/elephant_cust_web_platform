jQuery.AutoComplete = function(selector){
	...
	strHtml.push('		<li class="AutoComplete_title">请选择邮箱类型</li>');
    strHtml.push('		<li hz="@jiweitech.com"></li>');
	strHtml.push('		<li hz="@qq.com"></li>');
    strHtml.push('		<li hz="@139.com"></li>');
    ...
    strHtml.push('		<li hz="@icloud.com"></li>');
	strHtml.push('	</ul>');
	strHtml.push('</div>');
	
	$('#name_div').append(strHtml.join(''));
