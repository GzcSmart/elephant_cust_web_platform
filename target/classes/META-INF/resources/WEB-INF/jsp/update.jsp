        ...
        function saveInvoice() {
            $.ajax({
                ...
                data: {
                    ...
                    'busLicUrl': $("#file1").val(),
                    'custLicUrl': $("#file2").val(),
                    'otherLicUrl': $("#file3").val(),
                    'remark': $("#remark").val()
                },
                cache: false,
                                        ...
                                        <div class="panel-body" style="border:1px solid #e4e9eb;">
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input id="invoiceTitle" type="text" name="title" lay-verify="title"
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input id="taxNum" type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           value="${invoiceByCustomerId.taxNum}">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label" style="padding: 7px 0">* 开户行名称&nbsp;&nbsp;</label>
                                                <div class="layui-input-block">
                                                    <input id="bankName" type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           value="${invoiceByCustomerId.bankName}">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label" style="padding: 7px 0">* 开户行账号&nbsp;&nbsp;</label>
                                                <div class="layui-input-block">
                                                    <input id="bankNum" type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           value="${invoiceByCustomerId.bankNum}">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label" style="padding: 7px 0">* 营业电话&nbsp;&nbsp;</label>
                                                <div class="layui-input-block">
                                                    <input id="mobile" type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           value="${invoiceByCustomerId.mobile}">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label" style="padding: 7px 0">* 营业地址&nbsp;&nbsp;</label>
                                                <div class="layui-input-block">
                                                    <input id="address" type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           value="${invoiceByCustomerId.address}">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">* 纳税人资格类型</label>
                                                <div class="layui-input-block" style="line-height: 36px">
                                                    小规模纳税人<input type="radio" name="taxType" value="1" title="小规模纳税人"
                                                                 <c:if test="${invoiceByCustomerId.taxType == 1}">checked</c:if>/>
                                                    一般纳税人<input type="radio" name="taxType" value="0" title="一般纳税人"
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input id="file1" style="display: inline-block;margin-right: 10px"
                                                           type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           disabled="disabled" value="${invoiceByCustomerId.busLicUrl}">
                                                    <button type="button" class="layui-btn" id="licensefile">上传</button>
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    ...
                                                    <button type="button" class="layui-btn" id="taxpayerfile">上传
                                                    </button>
                                                    <button type="button" class="layui-btn">预览</button>
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    ...
                                                    <button type="button" class="layui-btn" id="otherfile">上传</button>
                                                    <button type="button" class="layui-btn">预览</button>
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-input-block">
                                                    <input id="remark" type="text" name="title" lay-verify="title"
                                                           autocomplete="off" placeholder="" class="layui-input"
                                                           value="${invoiceByCustomerId.remark}">
                                                </div>
                                            </div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label"
                                            ...
                                            <button type="button" class="layui-btn" onclick="saveInvoice()">提交</button>
                                            <button type="button" class="layui-btn" onclick="reload()">重置</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
