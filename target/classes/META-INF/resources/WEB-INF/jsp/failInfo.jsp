        ...
        <div class="panel">
            ...
            <div class="panel plain panel-default panelMove">
                ...
                <div class="panel-body">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background: rgb(229,245,255);">
                                    <h3 class="col-lg-offset-1" style="margin-left: 0px;">
                                        <i class="lnr lnr-sad" style="color: red;"></i>企业资质提示
                                    </h3>
                                </div>
                                <div class="panel-body">
                                    <p style="font-size:16px">sorry！您的企业未通过审核</p>
                                    <br>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="toaddIndividual" class="lnr lnr-pencil">
                        <button type="button" class="btn btn-primary">再次申请</button>
                    </a>
                </div>
            </div>
        </div>
