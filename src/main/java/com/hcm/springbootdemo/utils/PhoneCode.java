...
public class PhoneCode {
    ...
    public static void main(String[] args) {
      //  String phone = "13015912447"; //此处可输入你的手机号码进行测试
        // getPhonemsg(phone);
     ...
     * @return
     */
    public Result getPhonemsg(String mobile) {
        ...
        //获取验证码
        code = vcode();
        ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest().getSession().setAttribute("vcode",code);
        ...
        try {
            ...
            e.printStackTrace();
            result.setMessage("由于系统维护，暂时无法注册！！！");
            return result;
