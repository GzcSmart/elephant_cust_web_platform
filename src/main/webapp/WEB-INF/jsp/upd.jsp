...
<head>
    ...
    <script>
        ...
        function initAddress() {
            ...
            var city = $("#city").val();
            var district = $("#district").val();
            // alert($("#province")[0].text());
            // if (province == $("#province").each()){
            //   alert("1");
            // }
                    ...
                    <div class="panel panel-default toggle">
                        ...
                        <div class="panel-body" style="border:none;text-align: center">
                            <form class="layui-form" action="" method="post">
                                <input value="${customerAddress1.id}" hidden="hidden" id="id1">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input id="detailedArea" name="detailedArea" style="width: 500px" type="text"
                                               ...
                                               class="layui-input" value="${customerAddress1.detailedArea}">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input id="postcode" name="postalCode" style="width: 300px" type="text"
                                               ...
                                               class="layui-input" value="${customerAddress1.postalCode}">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input id="phone" name="phone" style="width: 300px" type="text"
                                               ...
                                               class="layui-input" value="${customerAddress1.phone}">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-block">
                                        <input id="mobile" name="telephone" style="width: 300px" type="text"
                                               ...
                                               class="layui-input" value="${customerAddress1.telephone}">
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <label class="layui-form-label" style="width: 85px">是否默认地址</label>
                                    <div class="layui-input-block" style="text-align: left">
                                        <input type="radio" name="DefaultAddress" value="1" title="是"
                                               <c:if test="${customerAddress1.isDefaultAddress == 1}">checked</c:if>>
                                        <input type="radio" name="DefaultAddress" value="0" title="否"
                                               <c:if test="${customerAddress1.isDefaultAddress == 0}">checked</c:if>>
                                    </div>
                                </div>
                                <button type="button" class="layui-btn" id="submit_address" onclick="">提交</button>
                            </form>
                        </div>
                    </div>
                    <!-- End .panel -->
